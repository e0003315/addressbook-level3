...
`* * *` | user | edit a person | updates the information of person
...
1. User requests to list persons using tag
2. AddressBook shows a list of persons with the tag
3. User requests to change the tag of persons with a specific tag in the list
4. AddressBook change the specific tag of the persons <br>
Use case ends.
...
6. Should have very fast runtime and performance.
